...
class ResidualChannelAttentionBlock(torch.nn.Module):
    ...
    def __init__(self, in_dim, reduction=4, relu_slope=0.2, use_bias=True):
        ...
        self.layer_norm = torch.nn.BatchNorm2d(in_dim)
        return
...
class ResidualDenseChannelAttentionBlock(torch.nn.Module):
    ...
    def __init__(self, in_channel, features, reduction=16, bias=True, dropout_rate=0.0):
        ...
        self.layer_normal = torch.nn.BatchNorm2d(in_channel)
...
class BottleneckBlock(torch.nn.Module):
    def __init__(self, in_channel,
        ...
        self.rdcab = ResidualDenseChannelAttentionBlock(
...
class TransformerUnet(torch.nn.Module):
    def __init__(self, in_channels, out_channels, depth=3, features=32, num_bottleneck_blocks=2):
...
if __name__ == '__main__':
    ...
    """
    model = TransformerUnet(in_channels=3, out_channels=3, depth=3, features=16, num_bottleneck_blocks=1)
