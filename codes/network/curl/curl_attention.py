...
class CurlAttentionNet(torch.nn.Module):
    def __init__(self, cfg):
        ...
        if cfg.MODEL.NETWORK.get('CURL_NET', None) is not None and cfg.MODEL.NETWORK.CURL_NET.get('KERNEL_NUMBER', None) is not None:
    ...
    def forward(self, x):
        ...
        img, gradient_regularization = CureApply.adjust_rgb(x, r)
