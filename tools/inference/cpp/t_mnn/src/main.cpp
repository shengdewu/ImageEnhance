...
void bat_test(std::string file_list_txt, std::string root_path, std::string out_root){
    ...
    std::string mnn_path = "/mnt/sda1/wokspace/ImageCureEnhance/inference/model/spline_att_model_13xy.mnn";
    ImgEnhance img_enhance(mnn_path, 16, false, 8);
...
int main(int argc, char** argv){
    ...
    // ImgEnhance img_enhance(mnn_path, down_scale, false, num_threads);
