...
int main(int argc, char** argv){
    ...
    std::string model_path = "/mnt/sda1/wokspace/ImageCureEnhance/inference/model/spline_att_model_13xy.tnnmodel";
    std::string proto_path = "/mnt/sda1/wokspace/ImageCureEnhance/inference/model/spline_att_model_13xy.tnnproto";

    auto init_time = std::chrono::system_clock::now();
    size_t down_scale = atoi(argv[1]);
    size_t num_threads = atoi(argv[2]);

    ImgEnhance img_enhance(proto_path, model_path, down_scale, false, num_threads);
